...
public interface HceServiceInterface {
	...
	//public Composition createComposition( String _startTime, String _otherContext, Long workflowId );
   public Composition createComposition( Date _startTime, String _otherContext, Long workflowId );
   
   //public boolean closeComposition( Composition composition, String endTime );
   public boolean closeComposition( Composition composition, Date endTime );
