...
%>
  ...
  <g:if test="${cObject instanceof CDomainType}">
      <g:render template="../guiGen/edit/cDomainType"
  ...
  <g:if test="${cObject instanceof CPrimitiveObject}">
      <g:render template="../guiGen/edit/cPrimitiveObject"
  ...
  <g:if test="${cObject instanceof ArchetypeSlot}">
      <g:render template="../guiGen/edit/archetypeSlot"
  ...
  <g:if test="${cObject instanceof ArchetypeInternalRef}">
      <g:render template="../guiGen/edit/archetypeInternalRef"
                model="[ref: cObject,
                        archetype: archetype,
                        archetypeService:archetypeService,
                        refPath: refPath,
