...
%>
  ...
  <g:if test="${cObject instanceof ConstraintRef}">
      <g:render template="../guiGen/create/constraintRef"
  ...
  <g:if test="${cObject instanceof CComplexObject}">
      <g:render template="../guiGen/create/cComplexObject"
  ...
  <g:if test="${cObject instanceof CDomainType}">
      <g:render template="../guiGen/create/cDomainType"
  ...
  <g:if test="${cObject instanceof CPrimitiveObject}">
      <g:render template="../guiGen/create/cPrimitiveObject"
  ...
  <g:if test="${cObject instanceof ArchetypeSlot}">
      <g:render template="../guiGen/create/archetypeSlot"
  ...
  <g:if test="${cObject instanceof ArchetypeInternalRef}">
      <g:render template="../guiGen/create/archetypeInternalRef"
                model="[ref: cObject,
                        archetype: archetype,
                        archetypeService:archetypeService,
                        refPath: refPath,
