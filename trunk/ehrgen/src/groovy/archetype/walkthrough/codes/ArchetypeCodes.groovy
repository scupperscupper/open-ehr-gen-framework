package archetype.walkthrough.codes
...
class ArchetypeCodes {
    ...
    * @return
    */
   public void setFlatArchetypeId(String toArchId)
   {
   ...
   public String getMappedCode(String archId, String code)
   {
      ...
      if (!mappedCode) throw new Exception("The archetype $archId doesn't have the code $code in it's definition") // Que pasa sino esta? El arquetipo esta mal definido.
