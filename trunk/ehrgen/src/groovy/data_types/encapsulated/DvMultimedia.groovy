...
class DvMultimedia extends DvEncapsulated {
     ...
     public boolean validate()
     {
        ...
        if (!mediaType)
        {
           //errors.addError('mediaType', 'DvMultimedia.mediaType es vacio', mediaType)
           errors.rejectValue('mediaType', "DvMultimedia.error.incomplete")
           valid = false
        }
        if (!compressionAlgorithm)
        {
           //errors.addError('compressionAlgorithm', 'DvMultimedia.compressionAlgorithm es vacio', compressionAlgorithm)
           errors.rejectValue('compressionAlgorithm', "DvMultimedia.error.incomplete")
           valid = false
        }
