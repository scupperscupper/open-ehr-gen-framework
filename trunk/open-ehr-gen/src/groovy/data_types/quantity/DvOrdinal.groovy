...
import data_types.quantity.DvOrdered
...
class DvOrdinal extends DvOrdered { //<DvOrdinal> {
   ...
   public boolean validate()
   {
      ...
      if (!value)
      {
         ...
         errors.rejectValue('value', "DvOrdinal.error.incomplete")
         valid = false
      }
      if (!symbol)
      {
         //errors.addError('symbol', '', symbol)
         errors.rejectValue('symbol', "DvOrdinal.error.incomplete")
         valid = false
      }
