...
class TermMapping {
    ...
    public boolean validate()
    {
       if (!target)
       {
          //errors.addError('target', '', target)
          errors.rejectValue('target', "TermMapping.error.incomplete")
          return false
       }
       return true
    }
    ...
    /*
    public DvCodedText getPurpose() { return purpose }
    public void setPurpose(DvCodedText pur) { purpose = pur }
    
    public CodePhrase getTarget() { return target }
    public void setTarget(CodePhrase tar) { target = tar }
    */
