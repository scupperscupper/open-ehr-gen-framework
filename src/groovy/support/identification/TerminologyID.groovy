...
class TerminologyID extends ObjectID {
    ...
    // FIXME: que la version y el id esten separados por espacio puede dar lugar a errores, porque el id podria tener espacios.
    // Momentaneamiente le pongo :: como separador. 
